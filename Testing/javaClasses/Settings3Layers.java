...
public abstract class Settings3Layers {
  ...
  public static final Source[] SOURCES = new Source[]{
    new Source()
      ...
      .withEventOutput("/opt/flink/sample1.data")
      .withDownStreamOperators(new String[]{"o1", "o2", "r1"})
    ,
    new Source()
      .withName("s2")
      .withOutputTypes("0 1 2 3".split(" "))
      .withBatchSize(BATCH_SIZE)
      .withRecordsPerSecond(RECORDS_PER_SECOND)
      .withEventOutput("/opt/flink/sample2.data")
      .withDownStreamOperators(new String[]{"o2", "o3", "r2"})
    ,
    new Source()
      .withName("s3")
      .withOutputTypes("0 1 2 3".split(" "))
      .withBatchSize(BATCH_SIZE)
      .withRecordsPerSecond(RECORDS_PER_SECOND)
      .withEventOutput("/opt/flink/sample3.data")
      .withDownStreamOperators(new String[]{"o7", "r3"})
  };
