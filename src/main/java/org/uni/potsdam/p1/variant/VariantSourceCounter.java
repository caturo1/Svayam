...
public class VariantSourceCounter extends ProcessFunction<Measurement, Metrics> {
  ...
  @Override
  public void processElement(Measurement value, ProcessFunction<Measurement, Metrics>.Context ctx, Collector<Metrics> out) throws Exception {
